...
const Ellipses = [
  ...
  'hidden lg:absolute left-1/2 top-8 bg-gradient-ellipse-3',
  'absolute -right-20 -bottom-20 bg-gradient-ellipse-2',
  'absolute right-0 top-0 bg-gradient-ellipse-1',
  'absolute -left-20 -top-20 lg:left-16 lg:top-0 bg-gradient-ellipse-3',
  'absolute left-1/3 bottom-1/3 bg-gradient-ellipse-2',
  'absolute -left-20 lg:left-1/2 -bottom-20 lg:-bottom-20 bg-gradient-ellipse-4',
]
